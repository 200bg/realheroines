...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rh_heroine', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True, default=datetime.datetime(2014,6,4,0,0,0)),
                      keep_default=False)
        db.add_column('rh_heroine', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, default=datetime.datetime(2014,6,4,0,0,0)),
                      keep_default=False)

    def backwards(self, orm):
        db.delete_column('rh_heroine', 'created_at')
        db.delete_column('rh_heroine', 'updated_at')
    ...
    models = {
        'rh.heroine': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True', 'default': 'datetime.datetime(2014,6,4,0,0,0)'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True', 'default': 'datetime.datetime(2014,6,4,0,0,0)'})
        },
        'rh.quote': {
