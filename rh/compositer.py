...
def composite_pack_with_background(path_to_pack):
    parts = OrderedDict({})
    img = None
    ...
    composite = Image.new('RGBA', size, (252, 202, 43, 255))
    ...
    composite_path = os.path.join(path_to_pack, 'pinnable-composite.png')
    composite.save(composite_path, 'PNG')
